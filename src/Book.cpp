...
std::optional<lob::Order> lob::Book::matchOrder(Order incomingOrder) {
...
bool lob::Book::updateLowestSell() {
...
bool lob::Book::updateHighestBuy() {
...
void lob::Book::cancelOrder(OrderId orderId) {
